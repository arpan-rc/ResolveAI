      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-lg w-full p-6 shadow-2xl space-y-6 relative overflow-hidden">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-slate-800">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-bold text-white">AI Service & Fallback Control</h3>
              <p className="text-xs text-slate-400">ResolveAI Modular Architecture Test Bench</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="bg-slate-950/60 p-4 rounded-xl border border-slate-800/80 space-y-3">
          <div className="flex items-center justify-between">
            <div>
              <span className="text-xs font-bold text-white block">Force Fallback Mode</span>
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                aiStatus?.forceFallback ? 'bg-amber-500' : 'bg-slate-700'
              }`}
            >
              <span
        ...
        <div className="space-y-2 text-xs text-slate-300">
          <span className="font-semibold text-slate-200 block">ResolveAI Reliability Guarantees:</span>
